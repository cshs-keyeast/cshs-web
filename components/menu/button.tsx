  ...
  return (
    <div>
      <div className="xl:opacity-100 opacity-0">
        ...
        { (Number(data?.user.admin) & 8) === 8 && <Link href='/d/admin/afterschool'>
          <div className="px-4 py-[10px] transition-all rounded-xl flex items-center justify-between cursor-pointer hover:bg-gray-100 active:bg-gray-200">
            <div className="flex items-center space-x-3">
              { !pathname.includes('/d/admin/afterschool') && <svg className="stroke-lightgray-300 w-6 h-6" fill="none" strokeWidth={2} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0ZM3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.25h.007v.008H3.75v-.008Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
              </svg> }
              { pathname.includes('/d/admin/afterschool') && <svg className="fill-zinc-800 w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path fillRule="evenodd" d="M6 4.75A.75.75 0 0 1 6.75 4h10.5a.75.75 0 0 1 0 1.5H6.75A.75.75 0 0 1 6 4.75Zm0 5A.75.75 0 0 1 6.75 9h10.5a.75.75 0 0 1 0 1.5H6.75A.75.75 0 0 1 6 9.75ZM6.75 14a.75.75 0 0 0 0 1.5h10.5a.75.75 0 0 0 0-1.5H6.75ZM3.75 4.75a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.375a.375.375 0 1 0 0-.75.375.375 0 0 0 0 .75Z" clipRule="evenodd" />
              </svg> }
              <div className={ pathname.includes('/d/admin/afterschool') ? "text-[17.5px] font-bold text-zinc-800" : "text-[17.5px] font-bold text-lightgray-300" }>방과후 시간표 관리</div>
            </div>
            <div className="flex space-x-1">
            </div>
          </div>
